...
class NovoNordiskFetcher(CompanyFetcher):
    """Novo Nordisk 爬蟲"""

    company_id = "novo_nordisk"
    company_name = "Novo Nordisk"
    news_url = "https://www.novonordisk.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.novonordisk.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Novo Nordisk")
        return documents
