...
class AbbvieFetcher(CompanyFetcher):
    """AbbVie 爬蟲"""

    company_id = "abbvie"
    company_name = "AbbVie"
    news_url = "https://www.abbvie.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from AbbVie")
        return documents
