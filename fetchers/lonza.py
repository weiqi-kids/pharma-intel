...
class LonzaFetcher(CompanyFetcher):
    """Lonza Group 爬蟲"""

    company_id = "lonza"
    company_name = "Lonza Group"
    news_url = "https://www.lonzagroup.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.lonzagroup.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Lonza Group")
        return documents
