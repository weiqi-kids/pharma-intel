...
class MerckFetcher(CompanyFetcher):
    """Merck & Co. 爬蟲"""

    company_id = "merck"
    company_name = "Merck & Co."
    news_url = "https://www.merck&co.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.merck&co.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Merck & Co.")
        return documents
