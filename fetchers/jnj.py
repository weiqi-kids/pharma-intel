...
class JnjFetcher(CompanyFetcher):
    """Johnson & Johnson 爬蟲"""

    company_id = "jnj"
    company_name = "Johnson & Johnson"
    news_url = "https://www.johnson&johnson.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.johnson&johnson.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Johnson & Johnson")
        return documents
