...
class NovartisFetcher(CompanyFetcher):
    """Novartis AG 爬蟲"""

    company_id = "novartis"
    company_name = "Novartis AG"
    news_url = "https://www.novartisag.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.novartisag.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Novartis AG")
        return documents
