...
class SanofiFetcher(CompanyFetcher):
    """Sanofi 爬蟲"""

    company_id = "sanofi"
    company_name = "Sanofi"
    news_url = "https://www.sanofi.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Sanofi")
        return documents
