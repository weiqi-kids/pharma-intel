...
class AstrazenecaFetcher(CompanyFetcher):
    """AstraZeneca 爬蟲"""

    company_id = "astrazeneca"
    company_name = "AstraZeneca"
    news_url = "https://www.astrazeneca.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.astrazeneca.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from AstraZeneca")
        return documents
