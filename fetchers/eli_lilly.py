...
class EliLillyFetcher(CompanyFetcher):
    """Eli Lilly 爬蟲"""

    company_id = "eli_lilly"
    company_name = "Eli Lilly"
    news_url = "https://www.elililly.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.elililly.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Eli Lilly")
        return documents
