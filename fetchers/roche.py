...
class RocheFetcher(CompanyFetcher):
    """Roche Holding 爬蟲"""

    company_id = "roche"
    company_name = "Roche Holding"
    news_url = "https://www.rocheholding.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.rocheholding.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Roche Holding")
        return documents
