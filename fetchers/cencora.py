...
class CencoraFetcher(CompanyFetcher):
    """Cencora 爬蟲"""

    company_id = "cencora"
    company_name = "Cencora"
    news_url = "https://www.cencora.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Cencora")
        return documents
