...
class CardinalFetcher(CompanyFetcher):
    """Cardinal Health 爬蟲"""

    company_id = "cardinal"
    company_name = "Cardinal Health"
    news_url = "https://www.cardinalhealth.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.cardinalhealth.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Cardinal Health")
        return documents
