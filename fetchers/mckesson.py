...
class MckessonFetcher(CompanyFetcher):
    """McKesson Corporation 爬蟲"""

    company_id = "mckesson"
    company_name = "McKesson Corporation"
    news_url = "https://www.mckessoncorporation.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.mckessoncorporation.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from McKesson Corporation")
        return documents
