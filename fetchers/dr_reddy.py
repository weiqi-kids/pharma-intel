...
class DrReddyFetcher(CompanyFetcher):
    """Dr. Reddy's Laboratories 爬蟲"""

    company_id = "dr_reddy"
    company_name = "Dr. Reddy's Laboratories"
    news_url = "https://www.drreddy'slaboratories.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.drreddy'slaboratories.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Dr. Reddy's Laboratories")
        return documents
