...
class CatalentFetcher(CompanyFetcher):
    """Catalent 爬蟲"""

    company_id = "catalent"
    company_name = "Catalent"
    news_url = "https://www.catalent.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.catalent.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Catalent")
        return documents
