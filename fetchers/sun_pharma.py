...
class SunPharmaFetcher(CompanyFetcher):
    """Sun Pharmaceutical 爬蟲"""

    company_id = "sun_pharma"
    company_name = "Sun Pharmaceutical"
    news_url = "https://www.sunpharmaceutical.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.sunpharmaceutical.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Sun Pharmaceutical")
        return documents
