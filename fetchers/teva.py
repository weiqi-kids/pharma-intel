...
class TevaFetcher(CompanyFetcher):
    """Teva Pharmaceutical 爬蟲"""

    company_id = "teva"
    company_name = "Teva Pharmaceutical"
    news_url = "https://www.tevapharmaceutical.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        for article in articles[:30]:
            ...
            if url and not url.startswith("http"):
                url = "https://www.tevapharmaceutical.com" + url
        ...
        logger.info(f"Parsed {len(documents)} news from Teva Pharmaceutical")
        return documents
