...
class PfizerFetcher(CompanyFetcher):
    """Pfizer 爬蟲"""

    company_id = "pfizer"
    company_name = "Pfizer"
    news_url = "https://www.pfizer.com/news"
    ...
    def parse_news(self, html: str) -> list[CompanyDocument]:
        ...
        logger.info(f"Parsed {len(documents)} news from Pfizer")
        return documents
