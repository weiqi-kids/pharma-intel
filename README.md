...
製藥供應鏈情報追蹤。每天自動抓取供應鏈上下游公司的新聞與股價，用規則引擎標記重要性與異常，產出每日與 7 日報告，並在網頁上呈現供應鏈關係圖與事件時間軸。

線上看：<http://pharma.intel.weiqi.kids/>
...
自動抓取的公開資訊，僅供研究參考，不是投資建議，也不是醫療或用藥建議。情緒與重要性評分是關鍵字規則的結果，不是人工判讀。
